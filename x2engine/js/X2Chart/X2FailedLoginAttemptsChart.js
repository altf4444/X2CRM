...
Based on X2ActionHistoryChart
*/



function X2FailedLoginAttemptsChart (argsDict) {
...
X2FailedLoginAttemptsChart.prototype = auxlib.create (X2Chart.prototype);

/*
Sets initial state of chart setting ui elements
*/
X2FailedLoginAttemptsChart.prototype.setDefaultSettings = function () {
	var thisX2Chart = this;
...
*/
X2FailedLoginAttemptsChart.prototype.chartDataFilter = function (dataPoint, type) {
	var thisX2Chart = this;
...
labels
*/
X2FailedLoginAttemptsChart.prototype.getMetricTypes = function () {
	var thisX2Chart = this;
...
*/
X2FailedLoginAttemptsChart.prototype.postPieChartTearDown = function () {
	var thisX2Chart = this;
...
*/
X2FailedLoginAttemptsChart.prototype.postPieChartSetUp = function () {
	var thisX2Chart = this;
